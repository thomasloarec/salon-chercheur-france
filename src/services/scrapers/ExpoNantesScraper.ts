    ...
    const mockEvents: ScrapedEvent[] = [
      {
        ...
        dateDebut: new Date(new Date().getFullYear() + 1, 4, 20), // May 20 next year
        dateFin: new Date(new Date().getFullYear() + 1, 4, 22), // May 22 next year
      ...
      },
      {
        ...
        dateDebut: new Date(new Date().getFullYear() + 1, 8, 10), // September 10 next year
        dateFin: new Date(new Date().getFullYear() + 1, 8, 12), // September 12 next year
        venue: 'Parc des Expositions de Nantes',
