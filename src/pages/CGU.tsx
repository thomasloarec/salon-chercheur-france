  ...
  return (
    <MainLayout title="Conditions Générales d'Utilisation">
      ...
      <div className="container mx-auto px-4 py-8 prose prose-lg max-w-4xl">
        <h1 className="heading-display text-3xl font-bold mb-6 text-foreground">Conditions Générales d'Utilisation (CGU)</h1>
        ...
        <section id="definitions" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">1. Définitions</h2>
          <p className="mb-4">
        ...
        <section id="objet" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">2. Objet du Site</h2>
          <p className="mb-4">
        ...
        <section id="acces" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">3. Accès au Site</h2>
          <p className="mb-4">
        ...
        <section id="compte" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">4. Création de compte</h2>
          <p className="mb-4">
        ...
        <section id="obligations" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">5. Obligations de l'Utilisateur</h2>
        ...
        <section id="contenu-utilisateur" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">6. Contenus générés par l'Utilisateur</h2>
          <p className="mb-4">
        ...
        <section id="propriete-intellectuelle" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">7. Propriété intellectuelle</h2>
          <p className="mb-4">
        ...
        <section id="responsabilite" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">8. Responsabilité</h2>
          <p className="mb-4">
        ...
        <section id="liens" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">9. Liens hypertextes</h2>
          <p className="mb-4">
        ...
        <section id="signalement" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">10. Signalement de contenus illicites</h2>
          <p className="mb-4">
        ...
        <section id="donnees-personnelles" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">11. Données personnelles</h2>
          <p className="mb-4">
        ...
        <section id="cookies" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">12. Cookies</h2>
          <p className="mb-4">
        ...
        <section id="modification" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">13. Modification des CGU</h2>
          <p className="mb-4">
        ...
        <section id="droit-applicable" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">14. Droit applicable – Litiges</h2>
          <p className="mb-4">
        ...
        <section id="contact" className="mb-8">
          <h2 className="heading-display section-rule text-xl font-semibold mb-4 text-foreground">15. Contact</h2>
          <p className="mb-4">
