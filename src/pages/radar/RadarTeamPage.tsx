...
import RadarCollaborationSection from '@/components/radar-crm/RadarCollaborationSection';
    ...
    <div className="font-body bg-muted/10 min-h-[calc(100vh-200px)]">
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-14 space-y-8">
        <div className="space-y-2">
          <h1 className="font-display text-3xl md:text-4xl font-semibold tracking-tight text-foreground">Espace et équipe</h1>
          <p className="text-sm text-muted-foreground">
            Gérez votre équipe, vos préférences d'alertes et vos données Radar CRM.
          </p>
        </div>
