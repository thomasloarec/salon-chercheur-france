...
export default function TrouverSalon() {
  const [search, setSearch] = useState('');
  const navigate = useNavigate();
  const emptyFilters = useMemo(() => ({ sectors: [], type: null, month: null, region: null }), []);
  ...
  return (
    <>
      <Helmet>
        <title>Trouver la fiche de votre salon | Lotexpo</title>
        <meta name="description" content="Recherchez votre salon professionnel sur Lotexpo pour consulter sa fiche, vérifier les informations affichées ou demander une mise à jour." />
        <link rel="canonical" href="https://lotexpo.com/trouver-un-salon" />
      </Helmet>
      <MainLayout title="Trouver un salon">
          ...
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <div className="text-center space-y-4 mb-10">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Recherchez votre salon professionnel pour consulter sa fiche, vérifier les informations affichées et voir comment il est présenté aux visiteurs.
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12 space-y-4">
                ...
                >
                  ...
                  Votre salon n'est pas encore référencé ? Contactez-nous
                </a>
              </div>
            ) : (
