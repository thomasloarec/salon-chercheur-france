        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-300 hover:text-accent transition-colors">Salons</Link></li>
              ...
              <li><Link to="/organisateurs" className="text-gray-300 hover:text-accent transition-colors">Organisateurs de salons</Link></li>
