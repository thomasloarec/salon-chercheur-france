...
export default function AdminSalonClaimsList({ onSelectSalon }: Props) {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium flex items-center gap-2">
                      {onSelectSalon && request.event ? (
                        <button
                          onClick={() => onSelectSalon(request.event!.id)}
                          className="hover:text-primary hover:underline text-left"
                        >
                          {request.event.nom_event}
                        </button>
                      ) : (
