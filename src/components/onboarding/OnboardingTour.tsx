    ...
    illustration: (
      <div className="flex flex-col items-center gap-3 py-4">
        <div className="relative">
          ...
          <div className="absolute -top-2 -right-2 w-9 h-9 rounded-full bg-primary flex items-center justify-center shadow-lg animate-bounce">
          ...
          {[1, 2, 3].map(i => (
            <div key={i} className="flex items-center gap-2">
              <div className="w-6 h-6 rounded bg-muted flex items-center justify-center flex-shrink-0">
                <CalendarCheck className="h-3 w-3 text-foreground" />
              </div>
          ...
          {['Acme Corp · Salon Industrie 2026', 'Globex · SIAL Paris', 'Initech · Vivatech'].map((line) => (
            <div key={line} className="flex items-center gap-2">
              <div className="w-5 h-5 rounded bg-muted flex items-center justify-center flex-shrink-0">
                <Radar className="h-3 w-3 text-foreground" />
              </div>
