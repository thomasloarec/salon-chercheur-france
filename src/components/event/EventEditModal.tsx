...
export const EventEditModal = ({ event, open, onOpenChange, onEventUpdated }: EventEditModalProps) => {
  ...
  const onSubmit = async (data: EventFormData) => {
    ...
    try {
      ...
      // Using actual database column names that exist
      const typedRefreshedEvent: Event = {
        id: refreshedEventData.id,
        nom_event: refreshedEventData.name || '',
        description_event: refreshedEventData.description,
        date_debut: refreshedEventData.start_date,
        date_fin: refreshedEventData.end_date,
        secteur: refreshedEventData.sector || '',
        nom_lieu: refreshedEventData.venue_name,
        ville: refreshedEventData.city,
        region: refreshedEventData.region,
        country: refreshedEventData.country,
        url_image: refreshedEventData.image_url,
        url_site_officiel: refreshedEventData.website_url,
        tags: refreshedEventData.tags,
        tarif: refreshedEventData.entry_fee,
        affluence: refreshedEventData.estimated_visitors,
        estimated_exhibitors: refreshedEventData.estimated_exhibitors,
        is_b2b: refreshedEventData.is_b2b,
        type_event: refreshedEventData.event_type as Event['type_event'],
        ...
        rue: refreshedEventData.address,
        code_postal: refreshedEventData.postal_code,
