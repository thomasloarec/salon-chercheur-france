-- BLOC A: extend notifications_type_check to allow 'claim_request' (admin in-app
-- notification on claim submission), preserving ALL existing values incl. 'claim_approved'.
