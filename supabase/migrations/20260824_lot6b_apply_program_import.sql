-- Lot 6b — Application d'un import de programme : materialise le staging en
-- sessions + intervenants + rattachements REELS, en brouillon (source pdf_import),
-- de facon atomique. Garde owner-ou-admin. Refuse si l'import n'est pas 'extracted'.
-- Deja appliquee en base via apply_migration le 2026-08-24 (logique testee OK).
