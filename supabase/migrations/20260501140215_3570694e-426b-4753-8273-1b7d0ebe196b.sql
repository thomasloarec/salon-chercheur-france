...
DROP FUNCTION IF EXISTS public.scan_event_duplicates(text, uuid, boolean);
...
BEGIN
  ...
  RETURN jsonb_build_object('ok', true, 'scanned', v_count, 'errors', v_errors, 'only_future', p_only_future);
END;
$function$;
