...
-- Migration: Correct the column renaming - name should become nom_event
-- First undo the incorrect rename, then apply the correct one

ALTER TABLE public.events RENAME COLUMN name_event TO nom_event;

-- Update the search_events function to use the correct column name
