...
-- Add comprehensive debugging logs to identify the sector filtering issue
...
BEGIN
  ...
  -- NOUVEAU: Log complet de la requête SQL et de ses paramètres
  RAISE NOTICE 'SQL généré: % — params: page_size=% offset=% sector_ids=% event_types=% months=%',
    query_text, page_size, offset_value, sector_ids, event_types, months;
